...
import com.example.estudiarv1.databinding.ActivityMapsBinding;

public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityMapsBinding binding;
    Pokemon pokemon = new Pokemon(); //crear pokemon
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pokemon!= null){
            ...
            longitud = Double.parseDouble(pokemon.getLongitud());
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Estás en" + pokemon.getNombre()));
